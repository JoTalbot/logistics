...
class TelegramIngestionStore:
    """PostgreSQL persistence boundary for Telegram ingestion."""

    def __init__(self, dsn: str):
        self.dsn = dsn

    def ingest_message(self, tenant_id: UUID, message: TelegramSourceMessage, parsed: ParsedLoadAd) -> UUID:
        """Persist source, parser result and checkpoint in one transaction."""
